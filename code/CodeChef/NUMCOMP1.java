...
class Codechef {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            boolean[] primes = util.sieveOfEr_primes(10000000);

            int[] prefixprimecounts = new int[10000001];
            prefixprimecounts[0] = 0;
            prefixprimecounts[1] = 0;
            for (int i = 2; i < 10000001; i++) {
                prefixprimecounts[i] = prefixprimecounts[i - 1];
                if (primes[i])
                    prefixprimecounts[i]++;
            }
            ...
            while (t > 0) {
                ...
                if (n == 2)
                    ...
                    out.println(prefixprimecounts[n] - prefixprimecounts[n / 2] + 1);
                // out.println(prefixprimecounts[n] + " " + prefixprimecounts[n / 2] + " " + 1);
                t--;
            }
            out.flush();
